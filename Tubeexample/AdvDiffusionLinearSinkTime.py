...
[node_array, node_coordinates, element_array, element_nodes_array, 
 inlet_node_array] = read_ansys_mesh('./', 'TubeBlockM.in')
...
independentField.ComponentValuesInitialiseDP(iron.FieldVariableTypes.U,iron.FieldParameterSetTypes.VALUES,3,5.0)
...
fields.NodesExport("TubeAdvDiffVel5p0_1p5", "FORTRAN")
